   ...
   ========================= */
{
 ...
 if(detail){
   ...
   const filteredUsers=[...users.values()].filter(u=>!resultSearch.trim()||`${u.name||''} ${u.userId||''}`.toLowerCase().includes(resultSearch.trim().toLowerCase()));
