...
if(!source.includes(oldSubmit)){if(source.includes(newSubmit)) { console.log('Evaluation form reset patch already applied.'); process.exit(0); } throw new Error('EVALUATION_PATCH_TARGET_NOT_FOUND:submit');}
