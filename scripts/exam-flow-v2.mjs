...
const cssFile='src/styles.css';let css=await fs.readFile(cssFile,'utf8');const marker='/* === EXAM FLOW V2 === */';if(!css.includes(marker)){css+='\n'+marker+'\n'+'.examStudentBanner{display:block;width:100%;max-height:320px;object-fit:cover;border-radius:18px;margin:0 0 14px;border:1px solid rgba(211,175,90,.2)}\n.examSectionStepper{display:flex;gap:8px;overflow:auto;padding:4px 0 12px;scrollbar-width:none}.examSectionStepper::-webkit-scrollbar{display:none}.examSectionStepper>div{display:flex;align-items:center;gap:7px;min-width:max-content;padding:8px 12px;border:1px solid rgba(92,125,166,.22);border-radius:12px;background:#081523;color:#8192a7}.examSectionStepper>div.active{border-color:rgba(211,175,90,.6);color:#e3c66f}.examSectionStepper>div.done{opacity:.8}.examSectionStepper span{width:24px;height:24px;display:grid;place-items:center;border-radius:50%;background:#122235}.examSectionHero{padding:14px;margin-bottom:14px;border-bottom:1px solid rgba(92,125,166,.18)}.examSectionHero>span{font-size:11px;color:#d3af5a}.examSectionHero h2{margin:5px 0}.examSectionHero p{color:#8ea0b4;margin:0;line-height:1.7}.examFlowActions{display:flex;justify-content:flex-end;gap:8px;margin-top:16px;padding-top:14px;border-top:1px solid rgba(92,125,166,.18)}\n@media(max-width:560px){.examStudentBanner{max-height:200px}.examFlowActions{flex-direction:column}.examFlowActions button{width:100%}}\n'}await fs.writeFile(cssFile,css,'utf8');
