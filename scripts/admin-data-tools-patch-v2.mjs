...
`;
await replaceOnce('server/academy-production-original.mjs',"app.put('/api/admin/question-bank'",cleanupRoutes+"app.put('/api/admin/question-bank'",'cleanup-routes');
