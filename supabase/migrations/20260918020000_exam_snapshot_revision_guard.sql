...
-- Keep the compatibility snapshot RPC server-only and make it populate the
-- normalized attempt_answers table atomically. A client revision/timestamp
-- guard prevents an older in-flight autosave from overwriting a newer one.
