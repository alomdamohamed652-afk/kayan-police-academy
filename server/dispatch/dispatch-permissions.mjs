...
export function dispatchCan(ctx,access,p){return Boolean(ctx?.admin)||Boolean(access?.enabled===true&&Array.isArray(access?.permissions)&&access.permissions.includes(p))}
